    ...
    return Scaffold(
        ...
        actions: [
          GestureDetector(
            ...
            child: ClayContainer(
              ...
              height: 30,
              borderRadius: 4,
              child: Icon(Icons.grid_on_sharp, color: Colors.grey.shade500, size: 20),
            ).marginOnly(right: 20),
          )
        ],
      ),
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          controller.liveStudentList.clear();
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index){
                if ((snapshot.data?.docs[index]['allot_seat_number']??"") != "") {
                  ...
                  controller.liveStudentList.add(StudentDataModel(
                    studentReferenceId: snapshot.data?.docs[index].reference.id??"",
                    allottedSeatNo: snapshot.data?.docs[index]['allot_seat_number']??"",
                    studentMobile: snapshot.data?.docs[index]['student_mobile'],
                    studentDateOfJoining: snapshot.data?.docs[index]['student_date_of_joining'],
                    studentInitialPayment: snapshot.data?.docs[index]['initial_payment'],
                    studentAddress: snapshot.data?.docs[index]['student_address'],
